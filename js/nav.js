document.addEventListener('DOMContentLoaded', () => {
    ...
    const adminNav = `<nav class="navbar bg-body-tertiary ">
...
`;
    ...
    const teacherNav = `<nav class="navbar bg-body-tertiary fixed-top">
        <div class="container-fluid">
...
`
    ...
    const studentNav = `<nav class="navbar bg-body-tertiary fixed-top mb-5">
        <div class="container-fluid">
